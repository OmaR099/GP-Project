...
import com.example.loginscreen.util.PlantBottomSheetFragment
import kotlinx.coroutines.launch
import pub.devrel.easypermissions.AppSettingsDialog
import pub.devrel.easypermissions.EasyPermissions
import java.text.SimpleDateFormat
import java.util.*
class CreatePlantFragment : BaseFragment(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imgUrlDelete = view.findViewById(R.id.imgUrlDelete)
        ...
        if (noteId != -1){
            ...
            launch {
                context?.let {
                    val notes = PlantDatabase.getDatabase(it).noteDao().getSpecificNote(noteId)
        ...
        imgMore.setOnClickListener{
            ...
            val noteBottomSheetFragment = PlantBottomSheetFragment.newInstance(noteId)
    ...
    private fun updateNote(){
        launch {
            ...
            context?.let {
                ...
                PlantDatabase.getDatabase(it).noteDao().updateNote(notes)
                etNoteTitle.setText("")
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            ...
            launch {
                ...
                notes.webLink = webLink
                context?.let {
                    PlantDatabase.getDatabase(it).noteDao().insertNotes(notes)
                    etNoteTitle.setText("")
                    etNoteSubTitle.setText("")
                    etNoteDesc.setText("")
                    layoutImage.visibility = View.GONE
    ...
    private fun deleteNote(){
        ...
        launch {
            context?.let {
                PlantDatabase.getDatabase(it).noteDao().deleteSpecificNote(noteId)
                requireActivity().supportFragmentManager.popBackStack()
            }
        }
    }
