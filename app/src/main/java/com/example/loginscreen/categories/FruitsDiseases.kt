...
class FruitsDiseases: AppCompatActivity() {
...
//        search()
        ...
        val name = arrayOf(
            "The fruit is deformed.",
            "Brown or black streaks have appeared on the fruit.",
            "There is a layer of white mold forming on the fruit's surface, Touch it, and it wipes off easily.",
            "The fruit has dried out from weathering.",
            "The fruit has softened and is starting to rot.",
            "These are signs of mold growing on the fruit's surface, sometimes accompanied by rotting."
        )
